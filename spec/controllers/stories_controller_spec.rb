  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested story" do
        ...
        Story.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => story.to_param, :story => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the story as @story" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Story.any_instance.stub(:save).and_return(false)
        put :update, {:id => story.to_param, :story => { "name" => "invalid value" }}, valid_session
        assigns(:story).should eq(story)
      end
